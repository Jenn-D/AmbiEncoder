    ...
    : AudioProcessorEditor(p), processor(p)
{
    ...
    addAndMakeVisible (sliderPanPosition = new Slider ("sliderPanPosition"));
...
void AmbiEncoderAudioProcessorEditor::resized()
{
    ...
    sliderPanPosition->setBounds (24, 24, 232, 224);
...
<JUCER_COMPONENT documentType="Component" className="AmbiEncoderAudioProcessorEditor"
  ...
  <SLIDER name="sliderPanPosition" id="2db7308534d7f2b5" memberName="sliderPanPosition"
          virtualName="" explicitFocusOrder="0" pos="24 24 232 224" min="0"
